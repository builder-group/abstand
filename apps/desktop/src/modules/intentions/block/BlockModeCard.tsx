		...
		<SettingsGroup title="Block">
			<div>
				<button
					...
					className="hover:bg-base-950/6 active:bg-base-950/10 flex min-h-10 w-full cursor-default items-center justify-between gap-6 px-4 py-2.5"
				>
					<span className="text-base-950 text-sm">Mode</span>
			...
			{isTargetsSelectable ? (
				<Link
					to="/window/main/intentions/new/block/targets"
					className="hover:bg-base-950/6 active:bg-base-950/10 flex min-h-10 items-center justify-between gap-6 px-4 py-2.5"
				>
