...
export type CreateIntentionConditionParams = { phase: IntentionConditionPhase; rule: IntentionConditionRule }
...
export type IntentionConditionDateTimeRule = { date: DateOnly; timeOfDay: TimeOnly }
